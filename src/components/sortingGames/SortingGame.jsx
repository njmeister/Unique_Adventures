...
export default function SortingGame({
	...
	const [initialContainerItems, setInitialContainerItems] =
		useState(initialContainers);
	...
	return (
		<>
			...
			<DndContext onDragEnd={handleDragEnd}>
				...
				{checkedItems.includes('Background') && (
				...
				<div className="initial-container-container">
					{initialContainerItems.map((container, index) => (
						<SortingGameInitialContainer
							...
							img={container.img}
							items={container.items.filter(
								(item) => !droppedItems[item.identity]
							)} // Filter out moved apples
						/>
					))}
				</div>
